...
func (hs *HTTPServer) getNavTree(c *models.ReqContext, hasEditPerm bool) ([]*dtos.NavLink, error) {
	...
	if c.OrgRole == models.ROLE_ADMIN {
		configNodes = append(configNodes, &dtos.NavLink{
			Text:        "Craft Metrics Setup",
			Id:          "cm-setup",
			Description: "Manage Craft Metrics",
			Icon:        "cog",
			Url:         setting.AppSubUrl + "/cmadmin/",
			Target:      "_top",
		})
		configNodes = append(configNodes, &dtos.NavLink{
			Text:        "Data sources",
...
func (hs *HTTPServer) setIndexViewData(c *models.ReqContext) (*dtos.IndexViewData, error) {
	...
	data := dtos.IndexViewData{
		...
		AppleTouchIcon:          "public/icons/apple-touch-icon.png",
		AppTitle:                "Craft Metrics",
		NavTree:                 navTree,
